...
public class LoginView {
    ...
    public static AnchorPane getScene() {
        ...
        //Loginbox
        Rectangle loginBox = new Rectangle(500, ScreenBounds.getHeight() - 200, Color.web("#D9D9D9"));
        ...
        //Loginbutton
        Rectangle loginButtonBackground = new Rectangle(400, 50);
        loginButtonBackground.setFill(linearGradient);
        RoundCorners.round(loginButtonBackground, 50);

        Label loginButtonLabel = new Label("LOGIN");
        //TODO: CSS
        loginButtonLabel.setStyle("-fx-text-fill: #D9D9D9;");
        loginButtonLabel.setFont(Font.font("", FontWeight.BLACK, 24));

        loginButton = new StackPane(loginButtonBackground, loginButtonLabel);
        ...
        //TODO: CSS
        loginTopLabel.setFont(Font.font("", FontWeight.BLACK, 24));
        loginTopLabel.setLayoutY(125);
        loginTopLabel.setPadding(new Insets(0, 0, 0, 200));
        ...
        //TODO: CSS
        usernameTextField.setBackground(Background.EMPTY);
        usernameTextField.setStyle("-fx-prompt-text-fill: #555555;");
        ...
        //TODO: CSS
        passwordLabel.setStyle("-fx-font-weight: 900");
        ...
        //TODO: CSS
        passwordPasswordField.setBackground(Background.EMPTY);
        passwordPasswordField.setStyle("-fx-prompt-text-fill: #555555;");
    ...
    public StackPane getLoginButton() {
        return loginButton;
    }
}